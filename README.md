...
> 2. `git clone https://github.com/714roy/agent-guardrails.git ~/agent-guardrails && mkdir -p ~/.hermes/plugins/agent-guardrails && cp -r ~/agent-guardrails/agentguard-plugin/* ~/.hermes/plugins/agent-guardrails/ && cp ~/agent-guardrails/config/enforcer-rules.yaml.example ~/.hermes/workspace/agent-guardrails-rules.md`
